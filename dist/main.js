...
eval("__webpack_require__.r(__webpack_exports__);\nasync function fetchNews(ticker) {\n    const url = `https://real-time-finance-data.p.rapidapi.com/stock-news?symbol=aapl%3ANASDAQ&language=en`\n    const options = {\n        method: 'GET',\n        headers: {\n            'X-RapidAPI-Key': 'da67ae36b6mshfed40a4fe258a74p18afdajsn4916c4fb8e2a',\n            'X-RapidAPI-Host': 'real-time-finance-data.p.rapidapi.com'\n        }\n    };\n\n    try {\n        const response = await fetch(url, options);\n        const result = await response.json();\n\n        // the actual news data is in the third item in the array,\n        // under the 'news' property\n        let newsData = result[2].news;\n\n        // we create an empty array to store our news\n        let newsArray = [];\n\n        // we loop over each item in the newsData array\n        for(let i = 0; i < newsData.length; i++) {\n            // we get the current news item\n            let newsItem = newsData[i];\n\n            // we create an object with the properties we're interested in\n            let newsObject = {\n                articlePhotoUrl: newsItem.article_photo_url,\n                articleTitle: newsItem.article_title,\n                articleUrl: newsItem.article_url,\n                postTimeUtc: newsItem.post_time_utc,\n                source: newsItem.source\n            };\n\n            // we add the newsObject to our array\n            newsArray.push(newsObject);\n        }\n\n        console.log(newsArray);\n    } catch (error) {\n        console.error(error);\n    }\n}\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (fetchNews);\n\n\n//# sourceURL=webpack://my_bloomberg/./src/scripts/fetchNews.js?");
